...
module "project_config" {
  source         = "github.com/GoogleCloudPlatform/cloud-foundation-fabric//modules/project?ref=v37.3.0&depth=1"
  name           = var.project_id
...
module "tf_state_backend" {
  source        = "github.com/GoogleCloudPlatform/cloud-foundation-fabric//modules/gcs?ref=v37.3.0&depth=1"
